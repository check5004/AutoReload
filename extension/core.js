...
(() => {
  ...
  globalThis.AR=Object.freeze({BUSY,HOLD,FINAL,defaults,profile,descriptor,origin,pattern,normalized,includesAll,classify,dateString,template,delay,expired,isNewer,repository});
})();
